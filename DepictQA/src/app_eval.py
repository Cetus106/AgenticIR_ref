...
def parse_args():
    ...
    parser.add_argument("--cfg", type=str, default="DepictQA/experiments/agenticir/config_eval.yaml")
...
@app.route("/evaluate_degradation", methods=["POST"])
def query():
    """Evaluates the level of degradation in an image.
...
if __name__ == "__main__":
    ...
    delta_ckpt = torch.load(cfg.model["delta_path"], map_location=torch.device("cuda:0" if torch.cuda.is_available() else "cpu"))
